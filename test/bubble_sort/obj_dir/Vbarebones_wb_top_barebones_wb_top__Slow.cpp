...
void Vbarebones_wb_top_barebones_wb_top::_ctor_var_reset() {
    ...
    __PVT__core0__DOT__core0__DOT__ctrl_unit_alu_func = VL_RAND_RESET_I(5);
    ...
    __PVT__core0__DOT__core0__DOT__mux3_o_ID = VL_RAND_RESET_I(22);
    ...
    __PVT__core0__DOT__core0__DOT__IDEX_preg_ex = VL_RAND_RESET_I(22);
